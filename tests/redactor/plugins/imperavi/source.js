(function($)
{
	$.Redactor.prototype.source = function()
	{
		return {
			...
			toggle: function()
			{
				var r =  (this.source.$textarea.hasClass('open')) ? this.source.hide() : this.source.show();
				this.core.editor().trigger('sourceToggle', {sourceMode:(this.source.$textarea.hasClass('open'))});
				return r;
			},
